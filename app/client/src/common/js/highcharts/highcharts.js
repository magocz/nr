...
(function (C, Z) {
    ...
    function K(a, b, c) {
        var d, e;
        if (xa(b))r(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (r(b) && X(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length)f = f.join(":"), g = /\.([0-9])/, h = S.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e !== null && (e = w.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Pa(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function $a(a) {
        return X(a) ? D(a) : {duration: a ? 500 : 0}
    }
    ...
    var z, A = C.document, W = Math, B = W.round, T = W.floor, ua = W.ceil, t = W.max, E = W.min, Q = W.abs, U = W.cos, aa = W.sin, qa = W.PI, ha = qa * 2 / 360, za = C.navigator && C.navigator.userAgent || "", Kb = C.opera, ya = /(msie|trident|edge)/i.test(za) && !Kb, lb = A && A.documentMode === 8, mb = !ya && /AppleWebKit/.test(za), La = /Firefox/.test(za), Lb = /(Mobile|Android|Windows Phone)/.test(za), Ga = "http://www.w3.org/2000/svg", ca = A &&
        A.createElementNS && !!A.createElementNS(Ga, "svg").createSVGRect, Pb = La && parseInt(za.split("Firefox/")[1], 10) < 4, ia = A && !ca && !ya && !!A.createElement("canvas").getContext, cb, db, Mb = {}, zb = 0, ib, S, Pa, G, Aa = function () {
    }, O = [], eb = 0, Ka = "div", Qb = /^[0-9]+$/, nb = ["plotTop", "marginRight", "marginBottom", "plotLeft"], pa, jb, rb, Za, ub, vb, wb, Ua, ab, bb, Fb, Gb, Hb, Ib, kb, xb, yb, I = {}, w;
    w = C.Highcharts ? Z(16, !0) : {win: C};
    w.seriesTypes = I;
    ...
    ka = function (a, b) {
        var c;
        if (b === "width")return Math.min(a.offsetWidth, a.scrollWidth) - ka(a, "padding-left") - ka(a, "padding-right"); else if (b === "height")return Math.min(a.offsetHeight, a.scrollHeight) - ka(a, "padding-top") - ka(a, "padding-bottom");
    ...
    H = function (a, b, c, d) {
        ...
        e = a.hcEvents;
        var f, g, c = c || {};
        if (A.createEvent && (a.dispatchEvent || a.fireEvent))e = A.createEvent("Events"), e.initEvent(b, !0, !0), e.target = a, s(e, c), a.dispatchEvent ? a.dispatchEvent(e) : a.fireEvent(b, e); else if (e) {
            e = e[b] || [];
            f = e.length;
    ...
    Wa = function (a, b, c) {
        var d, e = "", f, g, h;
        X(c) || (d = arguments, c = {duration: d[2], easing: d[3], complete: d[4]});
    ...
    P.prototype = {
        ...
        colorGradient: function (a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !r(g.gradientUnits) && (h = g, g = D(g, d.getRadialAttr(n, h), {gradientUnits: "userSpaceOnUse"}));
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)if (e = d[i], f = e.zIndex, e !== g && (F(f) > a || !r(a) && r(f)))c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
        },
    ...
    Ca.prototype = {
                ...
                o(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        h.test(e) && (y = e.match(h)[1].replace(/(;| |^)color([ :])/,
                            "$1fill$2"), K(v, "style", y));
                        i.test(e) && !d && (K(v, "onclick", 'location.href="' + e.match(i)[1] + '"'), L(v, {cursor: "pointer"}));
                        e = x(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            K(v, n);
                            b.appendChild(v);
                            !m && f && (!ca && d && L(v, {display: "block"}), K(v, "dy", sa(v)));
                            if (l) {
        ...
        arc: function (a, b, c, d, e, f) {
            ...
            if (i)h = this.path(i), s(h, {
                ...
                width: d,
                height: e
            }), f && s(h, f); else if (k.test(a))l = function (a, b) {
                a.element && (a.attr({
                    width: b[0],
                    height: b[1]
                ...
                x: b,
                y: c
            }), h.isImg = !0, a ? l(h, a) : (h.attr({width: 0, height: 0}), $("img", {
                onload: function () {
            ...
            var k = this, j = k.g(i), l = k.text("", 0, 0, g).attr({zIndex: 1}), m, n, q = 0, v = 3, y = 0, p, x, u, t, ob = 0, Y = {}, w, A, J, E, C;
            J = function () {
                var a,
                    b;
                a = l.element.style;
                ...
                if (A) {
                    ...
                    m.isImg || m.attr(s({width: B(j.width), height: B(j.height)}, Y));
                    Y = null
                }
            };
            E = function () {
                ...
                c = h ? 0 : w;
                if (r(p) && n && (a ===
                    "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (p - n.width);
    ...
    if (!ca && !ia) {
        M = {
            init: function (a, b) {
                ...
                for (var b = a.length, c = []; b--;)if (ma(a[b]))c[b] = B(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
                return c.join(" ") || "x"
            }, clip: function (a) {
                var b = this, c;
            ...
            shadow: function (a, b, c) {
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        h = $(g.prepVML(k), null, {left: F(i.left) + p(a.offsetX, 1), top: F(i.top) + p(a.offsetY, 1)});
                        if (c)h.cutOff = l + 1;
        ...
        var Bb = {
            ...
            isHidden: function () {
                ...
                return s(e, {
                    ...
                    getCSS: function (a) {
                        var b = a.element, c = b.nodeName, a = a.inverted, d = this.top - (c === "shape" ? b.offsetTop : 0), e = this.left, b = e + this.width, f = d + this.height, d = {clip: "rect(" + B(a ? e : d) + "px," + B(a ? f : b) + "px," + B(a ? b : f) + "px," + B(a ? d : e) + "px)"};
                        !a && lb && c === "DIV" && s(d, {width: b + "px", height: f + "px"});
                        return d
                    },
                ...
                if (i) {
                    ...
                    if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / qa) + '"', t(); else {
                ...
                } else if (g.test(a) && b.tagName !== "IMG")f = ja(a), d[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb"); else {
    ...
    Va.prototype = {
        addLabel: function () {
            ...
            if (h)h < 0 && c - i * k < f ? n = B(c / U(h * ha) - f) : h > 0 && c + i * k > e && (n = B((d - c) / U(h * ha))); else if (d = c + (1 - i) * k, c - i * k < f ? l = a.x + l * (1 - i) - f : d > e && (l = e - a.x + l * i, m = -1), l = E(j, l), l < j && b.labelAlign === "center" && (a.x += m * (j - l - i * (j - E(k, l)))), k > l || b.autoRotation && g.styles.width)n = l;
            if (n) {
                q.width = n;
    ...
    w.PlotLineOrBand.prototype =
    {
        render: function () {
            ...
            if (g) {
                if (n = b.getPlotLinePath(j, g), x = {stroke: v, "stroke-width": g}, l)x.dashstyle = l
            } else if (k) {
    ...
    fa.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (h)g = Ja(h, this); else if (c)g = b; else if (d)g = Pa(d, b); else if (f && a >= 1E3)for (; f-- && g === z;)c = Math.pow(1E3, f + 1), a >= c && b * 10 %
        ...
        setTickInterval: function (a) {
            ...
            if (v && r(b.dataMin))if (q = q || 0, !r(x) && b.min < q && b.dataMin >= q)b.min = q; else if (!r(u) && b.max >
        ...
        renderUnsquish: function () {
            ...
            if (i.rotation && (l = {width: (m > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + "px"}, !j))l.textOverflow = "ellipsis";
        ...
        getOffset: function () {
            ...
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(z), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(z), a.labelGroup = c.g("axis-labels").attr({zIndex: v.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add(z);
            if (k || a.isLinked) {
                if (o(e,
                        function (b) {
        ...
        render: function () {
            ...
            if (v)p = a.getLinePath(v), a.axisLine ? a.axisLine.animate({d: p}) : a.axisLine = c.path(p).attr({
                stroke: d.lineColor,
                "stroke-width": v,
                zIndex: 7
        ...
        drawCrosshair: function (a, b) {
            var c, d = this.crosshair,
                e, f;
            if (!this.crosshair || (r(b) || !p(d.snap, !0)) === !1)this.hideCrosshair(); else if (p(d.snap, !0) ? r(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)this.hideCrosshair(); else if (e = this.categories && !this.isRadial, f = p(d.width, e ? this.transA : 1), this.cross)this.cross.attr({
                d: c,
                visibility: "visible",
                "stroke-width": f
            }); else {
    ...
    fa.prototype.getLogTickPositions = function (a,
        ...
        if (a >= 0.5)a = B(a), i = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = T(b), k, j, l, m, n, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !n; f++) {
            j = e.length;
        ...
        init: function (a, b) {
            ...
            var d = this.chart, e = this.distance,
                f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop, d.plotTop, d.plotTop + d.plotHeight], k = ["x", d.chartWidth, a, c.plotX + d.plotLeft, d.plotLeft, d.plotLeft + d.plotWidth], j = !this.followPointer && p(c.ttBelow, !d.inverted === !!c.negative), l = function (a, b, c, d, h, i) {
                    ...
                    d += e;
                    if (j && m)f[a] = d; else if (!j && k)f[a] = l; else if (k)f[a] = E(i - c, l - g < 0 ? l : l - g); else if (m)f[a] = t(h, d + g + c > b ? d : d + g); else return !1
                }, m = function (a, b, c, d) {
                    var g;
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            return s(a, {chartX: B(c), chartY: B(d)})
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || d)o(c.axes, function (c) {
                    if (c.zoomEnabled && r(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                        ...
                        e[c.coll].push({axis: c, min: E(q, f), max: t(q, f)});
                        j = !0
                    }
            ...
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (H(c.series, "click", s(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (s(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && H(b, "click", a)))
    ...
    s(w.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            if (a.type === "touchstart")o(e, function (a, b) {
                ...
                if (!i)b.selectionMarker = i = s({destroy: Aa, touch: !0}, c.plotBox);
    ...
    pb.prototype =
    {
        ...
        var c = this.options, d = a.legendItem, e = a.legendLine, f = a.legendSymbol, g = this.itemHiddenStyle.color,
            c = b ? c.itemStyle.color : g, h = b ? a.legendColor || a.color || "#CCC" : g, g = a.options && a.options.marker, i = {fill: h}, k;
        ...
        if (a > f && k.enabled !== !1) {
            ...
            r(h);
            if (!m)this.nav =
                m = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, l, l).on("click", function () {
                b.scroll(-1, j)
    ...
    gb.prototype = {
        callbacks: [], getArgs: function () {
            ...
            d && (d.css({width: (e.width || h) + "px"}).align(s({y: b + (f.margin - 13) + g.fontMetrics(e.style.fontSize, c).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = ua(b + d.getBBox().height)));
            ...
            if (j)f ? f.animate(x) : this.plotBackground = b.rect(q, p, o, r, 0).attr({fill: j}).add().shadow(a.plotShadow);
            if (l)h ? h.animate(x) : this.plotBGImage = b.image(l, q, p, o, r).add();
            u ? u.animate({width: t.width, height: t.height}) : this.clipRect = b.clipRect(t);
    ...
    R.prototype = {
        ...
        setData: function (a, b, c, d) {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)o(a, function (a, b) {
                ...
                } else for (c = 0; c < h; c++)if (a[c] !== z && (j = {series: e}, e.pointClass.prototype.applyOptions.apply(j, [a[c]]), e.updateParallelArrays(j,
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)if (k =
                    c[l], j = a[l], i = j !== null && j !== z && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k)if (i = j.length)for (; i--;)j[i] !== null && (e[f++] = j[i]); else e[f++] = j;
            this.dataMin = Qa(e);
            this.dataMax = Fa(e)
        },
        translate: function () {
        ...
        applyZones: function () {
            ...
            if (d.length && (i || k) && l.min !== z)i && i.hide(), k && k.hide(), m = l.getExtremes(), o(d, function (d, o) {
                ...
                x = t(e, f);
                if (l.isXAxis) {
                    if (h = {x: q ? x : r, y: 0, width: y, height: j}, !v)h.x = b.plotHeight - h.x
                } else if (h = {x: 0, y: q ? x : r, width: j, height: y}, v)h.y = b.plotWidth - h.y;
    ...
    s(gb.prototype, {
        addSeries: function (a, b, c) {
            ...
            var e = b ? "xAxis" : "yAxis", f = this.options, a = D(a, {index: this[e].length, isX: b});
            new fa(this, a);
            f[e] = ta(f[e] || {});
            f[e].push(a);
            p(c, !0) && this.redraw(d)
            ...
            if (!d)b.loadingDiv =
                d = $(Ka, {className: "highcharts-loading"}, s(e.style, {
                    zIndex: 10,
                    display: "none"
    ...
    wa = oa(R, {
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                ...
                if (i !== z && !isNaN(i) && h.y !== null)f = h.shapeArgs, i = r(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], k ? (Na(k), k.attr(i).attr(g)[b.pointCount <
    ...
    ea = {
        ...
        translate: function (a) {
            ...
            for (m = 0; m < n; m++) {
                ...
                o.slicedTranslation = {translateX: B(U(h) * d), translateY: B(aa(h) * d)};
                f = U(h) * a[2] / 2;
                g = aa(h) * a[2] / 2;
        ...
        drawPoints: function () {
            ...
            o(a.points, function (k) {
                if (k.y !== null) {
                    ...
                    f && f.attr(c);
                    if (d)d.setRadialReference(a.center).attr(g).animate(s(h, c)); else {
    ...
    R.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", j && !h ? "hidden" :
            "visible", d.zIndex || 6), j && (k.attr({opacity: +h}), h || N(a, "afterAnimate", function () {
            a.visible && k.show();
            ...
            if (j && !h)e.dataLabel = j.destroy(); else if (h) {
                ...
                if (j)if (r(i))j.attr({text: i}), x = !1; else {
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (n)d = s({
            ...
            width: 0,
            height: 0
        }, d), s(c, {width: k.width, height: k.height}), l ? (o = !1, g = f.renderer.rotCorr(j,
            l), g = {
            x: d.x + c.x + d.width / 2 + g.x,
            y: d.y + c.y + d.height / 2
        }, b[e ? "attr" : "animate"](g).attr({align: c.align}), h = (l + 720) % 360, h = h > 180 && h < 360, m === "left" ? g.y -= h ? k.height : 0 : m === "center" ? (g.x -= k.width / 2, g.y -= k.height / 2) : m === "right" && (g.x -= k.width, g.y -= h ? 0 : k.height)) : (b.align(c, null, d), g = b.alignAttr), o ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)), c.shape && !l && b.attr({
            anchorX: a.plotX,
            anchorY: a.plotY
        });
        if (!n)Na(b), b.attr({y: -9999}), b.placed = !1
    };
    ...
    if (I.pie)I.pie.prototype.drawDataLabels = function () {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (F = 2; F--;) {
                ...
                if (M) {
                    ...
                    for (J =
                        ...
                        w._attr = {visibility: D, align: u[6]};
                        w._pos = {x: A + e.x + ({left: f, right: -f}[u[6]] || 0), y: C + e.y - 10};
                        w.connX = A;
                        w.connY = C;
            ...
            if (Fa(G) === 0 || this.verifyDataLabelOverflow(G))this.placeDataLabels(), s && g && o(this.points, function (b) {
                k = b.connector;
                u = b.labelPos;
                if ((w = b.dataLabel) && w._pos && b.visible)D = w._attr.visibility, A = w.connX, C = w.connY, j = l ? ["M", A + (u[6] === "left" ? 5 : -5), C, "C", A, C, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), C, "L", u[2], u[3], "L", u[4], u[5]], k ? (k.animate({d: j}), k.attr("visibility", D)) : b.connector = k = a.chart.renderer.path(j).attr({
    ...
    ea = w.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor, l = j && {cursor: j}, m = function () {
    ...
    s(gb.prototype, {
        showResetZoom: function () {
            ...
            if (d && !e)this.showResetZoom(); else if (!d && X(e))this.resetZoomButton = e.destroy();
            ...
            o(b === "xy" ? [1, 0] : [1], function (b) {
                ...
                if (b.series.length && (i || l > E(j.dataMin, j.min)) && (!i || k < t(j.dataMax, j.max)))b.setExtremes(l, k, !1, !1, {trigger: "pan"}), e = !0;
                c[d] = h
            });
            e && c.redraw(!1);
