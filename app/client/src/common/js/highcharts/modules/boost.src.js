...
(function (factory) {
     ...
     * If we use this in the lib, we can add the hook to hasExtremes to the methods directly.
     */
    ...
    H.extend(Series.prototype, {
        ...
        /**
         * If implemented in the lib, parts of this can probably be shared with other similar
        ...
        renderCanvas: function () {
            ...
            eachAsync(isStacked ? series.data : (xData || rawData), function (d, i) {
                ...
                // CSS animation looks good, but then it must be deleted in timeout. If we add the module to lib,
