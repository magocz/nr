...
if ($_SESSION['login'] == null) {
    ...
    if ($method == 'GET') {
        ...
        if (is_numeric($firstParam)) {
            echo $seasonBF->generatePlantToVarietesToCostTypeToCostDetails_ProField_CharData($firstParam);
        } else {
            echo $seasonBF->generatePlantToVarietesToCostTypeToCostDetails_ProField_CharData(null);
        }
    } else {
