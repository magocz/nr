...
if ($_SESSION['login'] == null) {
    ...
    if ($method == 'GET') {
        ...
        if (is_numeric($firstParam)) {
            echo $seasonBF->generatePlantToVarietesRevenuesDetails_ProHa_CharData($firstParam);
        } else {
            echo $seasonBF->generatePlantToVarietesRevenuesDetails_ProHa_CharData(null);
        }
    } else {
