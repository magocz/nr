...
if ($_SESSION['login'] == null) {
    ...
    if ($method == 'GET') {
        ...
        if (is_numeric($firstParam)) {
            echo $seasonBF->generatePlantToVarietesProfitDetails_ProField_CharData($firstParam);
        } else {
            echo $seasonBF->generatePlantToVarietesProfitDetails_ProField_CharData(null);
        }
    } else {
