...
//		}
    ...
    public function load($pFilename)
    {
        ...
        foreach ($rels->Relationship as $rel) {
            switch ($rel["Type"]) {
                case "http://schemas.openxmlformats.org/package/2006/relationships/metadata/lib-properties":
                    ...
                    if (is_object($xmlCore)) {
                        ...
                        $xmlCore->registerXPathNamespace("cp", "http://schemas.openxmlformats.org/package/2006/metadata/lib-properties");
