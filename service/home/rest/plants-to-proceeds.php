...
if ($_SESSION['login'] == null) {
    ...
    if ($method == 'GET') {
        ...
        if (is_numeric($firstParam)) {
            echo generateActiveSeasonColumnChartData_plants_to_proceeds($firstParam);
        } else {
            echo generateActiveSeasonColumnChartData_plants_to_proceeds($_SESSION['activeSeasonId']);
        }
    }
}